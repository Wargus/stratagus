...
for i = 1, 13 do
	DefineUnitType("unit-crystal-field" .. i, {
		...
		NewAnimations = "animations-crystal-field" .. i, Icon = "icon-crystal-field",
...
DefineUnitType("unit-gold-mine", {
	...
	NewAnimations = "animations-building", Icon = "icon-tita",
...
DefineUnitType("unit-dead-body", {
	...
	NewAnimations = "animations-dead-body", Icon = "icon-cancel",
...
DefineUnitType("unit-destroyed-1x1-place", { Name = "Destroyed 1x1 Place",
	...
	Size = {32, 32},
	NewAnimations = "animations-destroyed-place", Icon = "icon-cancel",
