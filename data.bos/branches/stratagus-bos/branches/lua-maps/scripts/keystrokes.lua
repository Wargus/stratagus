...
AddKeystrokeHelp("Alt-F", "- toggle full screen")
...
AddKeystrokeHelp("PRINT", "- make screen shot")
...
AddKeystrokeHelp("TAB", "- hide/unhide terrain")
AddKeystrokeHelp("Ctrl-T", "- track unit")
AddKeystrokeHelp("Alt-I", "- find idle peon")
