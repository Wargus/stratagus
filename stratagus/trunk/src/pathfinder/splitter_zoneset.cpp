...
*/
void ZoneSetAddUnitZones(ZoneSet *source, const CUnit *src)
{
	int unitmask;
...
*/
void ZoneSetAddGoalZones(ZoneSet *dest, const CUnit *src, int goal_x,
    int goal_y, int w, int h, int minrange, int maxrange)
{
