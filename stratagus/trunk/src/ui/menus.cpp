...
local Menuitem SoundOptionsMenuItems[] = {
    ...
    { MI_TYPE_TEXT, 58, 36*6.5 + 2, 0, LargeFont, NULL, NULL,
    ...
    { MI_TYPE_TEXT, 180, 36*6.5 + 2, 0, LargeFont, NULL, NULL,
	...
	{ gem:{ MI_GSTATE_UNCHECKED, 18, 18, MBUTTON_GEM_SQUARE, SetCdPower} } },
    { MI_TYPE_TEXT, 266, 36*5.5 + 2, -1, LargeFont, NULL, NULL,
	{ text:{ "Enabled", MI_TFLAGS_LALIGN} } },
    { MI_TYPE_GEM, 32, 36*6.5, -1, LargeFont, NULL, NULL,
	{ gem:{ MI_GSTATE_UNCHECKED, 18, 18, MBUTTON_GEM_ROUND, SetCdModeAll} } },
    { MI_TYPE_TEXT, 58, 36*6.5 + 2, -1, LargeFont, NULL, NULL,
	{ text:{ "All Tracks", MI_TFLAGS_LALIGN} } },
    { MI_TYPE_GEM, 154, 36*6.5, -1, LargeFont, NULL, NULL,
	{ gem:{ MI_GSTATE_UNCHECKED, 18, 18, MBUTTON_GEM_ROUND, SetCdModeRandom} } },
    { MI_TYPE_TEXT, 180, 36*6.5 + 2, -1, LargeFont, NULL, NULL,
	{ text:{ "Random Tracks", MI_TFLAGS_LALIGN} } },
...
local Menuitem KeystrokeHelpMenuItems[] = {
	...
	{ text:{ "Alt-F    - toggle full screen mode", MI_TFLAGS_LALIGN} } },
    { MI_TYPE_TEXT, 16, 40+20*1, 0, SmallFont, NULL, NULL,
	{ text:{ "Ctrl-S   - mute sound", MI_TFLAGS_LALIGN} } },
    { MI_TYPE_TEXT, 16, 40+20*2, 0, SmallFont, NULL, NULL,
	{ text:{ "Alt-Q    - quit to main menu", MI_TFLAGS_LALIGN} } },
    { MI_TYPE_TEXT, 16, 40+20*3, 0, SmallFont, NULL, NULL,
	{ text:{ "+         - increase game speed", MI_TFLAGS_LALIGN} } },
    { MI_TYPE_TEXT, 16, 40+20*4, 0, SmallFont, NULL, NULL,
	{ text:{ "-         - decrease game speed", MI_TFLAGS_LALIGN} } },
    { MI_TYPE_TEXT, 16, 40+20*5, 0, SmallFont, NULL, NULL,
	{ text:{ "Ctrl-P   - pause game", MI_TFLAGS_LALIGN} } },
    { MI_TYPE_TEXT, 16, 40+20*6, 0, SmallFont, NULL, NULL,
	{ text:{ "Alt-G    - toggle grab mouse", MI_TFLAGS_LALIGN} } },
    { MI_TYPE_TEXT, 16, 40+20*7, 0, SmallFont, NULL, NULL,
	{ text:{ "Alt-X    - quit game", MI_TFLAGS_LALIGN} } },
    { MI_TYPE_TEXT, 16, 40+20*8, 0, SmallFont, NULL, NULL,
	{ text:{ "Alt-B    - toggle expand map", MI_TFLAGS_LALIGN} } },
    { MI_TYPE_TEXT, 16, 40+20*9, 0, SmallFont, NULL, NULL,
	{ text:{ "ENTER    - write a message", MI_TFLAGS_LALIGN} } },
    { MI_TYPE_TEXT, 16, 40+20*10, 0, SmallFont, NULL, NULL,
	{ text:{ "TAB      - hide/unhide terrain", MI_TFLAGS_LALIGN} } },
    { MI_TYPE_TEXT, 16, 40+20*11, 0, SmallFont, NULL, NULL,
