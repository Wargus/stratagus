...
DefineUnitType("unit-plate1", {
	...
	NewAnimations = "animations-plate", Icon = "icon-plate1",
...
DefineUnitType("unit-apcs", {
	...
	NewAnimations = "animations-apcs", Icon = "icon-apcs",
...
DefineUnitType("unit-medic", {
	...
	NewAnimations = "animations-medic", Icon = "icon-medic",
...
DefineUnitType("unit-bazoo", {
	...
	NewAnimations = "animations-bazoo", Icon = "icon-bazoo",
...
DefineUnitType("unit-assault", {
	...
	NewAnimations = "animations-assault", Icon = "icon-assault",
...
DefineUnitType("unit-grenadier", {
	...
	NewAnimations = "animations-grenadier", Icon = "icon-grenadier",
...
DefineUnitType("unit-engineer", {
	...
	DrawLevel = 19, NewAnimations = "animations-engineer", Icon = "icon-engineer",
...
DefineUnitType("unit-harvester", {
	...
	DrawLevel = 25, NewAnimations = "animations-harvester", Icon = "icon-harvester",
...
DefineUnitType("unit-dorcoz", {
	...
	NewAnimations = "animations-dorcoz", Icon = "icon-dorcoz",
...
DefineUnitType("unit-msilo", {
	...
	NewAnimations = "animations-msilo", Icon = "icon-msilo",
...
DefineUnitType("unit-gen", {
	...
	NewAnimations = "animations-gen", Icon = "icon-gen",
...
DefineUnitType("unit-camp", {
	...
	NewAnimations = "animations-camp", Icon = "icon-camp",
...
DefineUnitType("unit-vault", {
	...
	NewAnimations = "animations-vault", Icon = "icon-vault",
...
DefineUnitType("unit-dev-yard", {
	...
	NewAnimations = "animations-dev-yard", Icon = "icon-dev",
...
DefineUnitType("unit-rfac", {
	...
	NewAnimations = "animations-rfac", Icon = "icon-rfac",
...
DefineUnitType("unit-hosp", {
	...
	NewAnimations = "animations-hosp", Icon = "icon-hosp",
...
DefineUnitType("unit-vfac", {
	...
	NewAnimations = "animations-vfac", Icon = "icon-vfac",
...
for i = 1, table.getn(CorpseTable) do
	DefineUnitType("unit-dead-body" .. i, {
		...
		Size = {64, 64},
		NewAnimations = "animations-elitecorpse1", Icon = "icon-cancel",
...
DefineUnitType("build-dead-body1", {
	...
	Files = {"tileset-desert", "elites/build/development_yard.png"}, Size = {224, 196},
	NewAnimations = "animations-elitebuild1", Icon = "icon-cancel",
...
DefineUnitType("build-dead-body2", {
	...
	Files = {"tileset-desert", "elites/build/generator.png"}, Size = {64, 64},
	NewAnimations = "animations-elitebuild2", Icon = "icon-cancel",
	Speed = 0, HitPoints = 999, DrawLevel = 10,
...
DefineUnitType("build-dead-body3", {
	Name = "CampCrater",
	Files = {"tileset-desert", "elites/build/training_camp.png"}, Size = {160, 128},
	NewAnimations = "animations-elitebuild3", Icon = "icon-cancel",
	Speed = 0, HitPoints = 999, DrawLevel = 10,
...
DefineUnitType("build-dead-body4", {
	Name = "RfacCrater",
	Files = {"tileset-desert", "elites/build/research_facility.png"}, Size = {128, 128},
	NewAnimations = "animations-elitebuild4", Icon = "icon-cancel",
	Speed = 0, HitPoints = 999, DrawLevel = 10,
...
DefineUnitType("build-dead-body5", {
	Name = "HospCrater",
	Files = {"tileset-desert", "elites/build/hospital.png"}, Size = {128, 96},
	NewAnimations = "animations-elitebuild5", Icon = "icon-cancel",
...
DefineUnitType("build-dead-body6", {
	Name = "FactoryCrater",
	Files = {"tileset-desert", "elites/build/vehicle_factory.png"}, Size = {224, 160},
	NewAnimations = "animations-elitebuild6", Icon = "icon-cancel",
...
DefineUnitType("build-dead-body7", {
	Name = "SiloCrater",
	Files = {"tileset-desert", "elites/build/missile_silo.png"}, Size = {128, 128},
	NewAnimations = "animations-elitebuild7", Icon = "icon-cancel",
