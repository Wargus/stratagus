...
** Generated automatically by tolua++-1.0.92 on 02/19/11 21:17:58.
*/
...
static int tolua_set_CServerSetup_unsigned_ResourcesOption(lua_State* tolua_S)
{
  ...
  if (!tolua_isnumber(tolua_S,2,0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->ResourcesOption = ((unsigned int)  tolua_tonumber(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_set_CServerSetup_unsigned_UnitsOption(lua_State* tolua_S)
{
  ...
  if (!tolua_isnumber(tolua_S,2,0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->UnitsOption = ((unsigned int)  tolua_tonumber(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_set_CServerSetup_unsigned_FogOfWar(lua_State* tolua_S)
{
  ...
  if (!tolua_isnumber(tolua_S,2,0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->FogOfWar = ((unsigned int)  tolua_tonumber(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_set_CServerSetup_unsigned_RevealMap(lua_State* tolua_S)
{
  ...
  if (!tolua_isnumber(tolua_S,2,0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->RevealMap = ((unsigned int)  tolua_tonumber(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_set_CServerSetup_unsigned_TilesetSelection(lua_State* tolua_S)
{
  ...
  if (!tolua_isnumber(tolua_S,2,0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->TilesetSelection = ((unsigned int)  tolua_tonumber(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_set_CServerSetup_unsigned_GameTypeOption(lua_State* tolua_S)
{
  ...
  if (!tolua_isnumber(tolua_S,2,0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->GameTypeOption = ((unsigned int)  tolua_tonumber(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_set_CServerSetup_unsigned_Difficulty(lua_State* tolua_S)
{
  ...
  if (!tolua_isnumber(tolua_S,2,0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->Difficulty = ((unsigned int)  tolua_tonumber(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_set_CServerSetup_unsigned_MapRichness(lua_State* tolua_S)
{
  ...
  if (!tolua_isnumber(tolua_S,2,0,&tolua_err))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->MapRichness = ((unsigned int)  tolua_tonumber(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
/* set function: tilePos of class  CUnit */
#ifndef TOLUA_DISABLE_tolua_set_CUnit_tilePos
static int tolua_set_CUnit_tilePos(lua_State* tolua_S)
{
  ...
  if ((tolua_isvaluenil(tolua_S,2,&tolua_err) || !tolua_isusertype(tolua_S,2,"Vec2i",0,&tolua_err)))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
  self->tilePos = *((Vec2i*)  tolua_tousertype(tolua_S,2,0))
;
 return 0;
}
#endif //#ifndef TOLUA_DISABLE
...
static int tolua_set_CMap_Tileset(lua_State* tolua_S)
{
  ...
  tolua_Error tolua_err;
  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'Tileset'",NULL);
  if ((tolua_isvaluenil(tolua_S,2,&tolua_err) || !tolua_isusertype(tolua_S,2,"CTileset",0,&tolua_err)))
   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
#endif
...
TOLUA_API int tolua_stratagus_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"CUnit");
   ...
   tolua_variable(tolua_S,"tilePos",tolua_get_CUnit_tilePos,tolua_set_CUnit_tilePos);
