...
public:
	COrder_Patrol() : COrder(UnitAction::Patrol) {}

	std::unique_ptr<COrder> Clone() const override { return std::make_unique<COrder_Patrol>(*this); }
...
private:
	Vec2i WayPoint{-1, -1}; /// position for patroling.
