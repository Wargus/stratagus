...
DefineAnimations("animations-tree02", {
...
DefineUnitType("unit-tree02", {
    Name = "Tree02",
    Image = {"file", "units/tree02/tree02.png", "size", {128, 128}},
    Offset = {0, -24},
    Shadow = {"file", "units/tree02/tree02_s.png", "size", {128, 128}},
    Animations = "animations-tree02",
    Icon = "icon-tree",
...
DefineAllow("unit-tree02", AllowAll)
