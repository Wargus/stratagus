...
function InitAiScripts_spacious()
...
local ai_loop_funcs = {
  ...
  function()
    ...
    return false -- to indicate the end of the loop (?)
  end,
}
...
local ai_funcs = {
  ...
  function()
    -- print("Ai " .. player .. " now has the basic resources to start building an attack force.");
  ...
  function() 
    -- print("Ai " .. player .. " is attacking with force 1a.");
  ...
  function() return AiWaitForce(1) end,
  function()
    -- print("Ai " .. player .. " is attacking with force 1b.");
    return AiAttackWithForce(1)
  end,
  ...
  function()
    -- print("Ai " .. player .. " is attacking with force 1c.");
    return AiAttackWithForce(1)
  end,
  ...
  function() return AiSleep((SyncRand(600)+400) * GameSettings.Difficulty) end,
  function()
    -- print("Ai " .. player .. " is attacking with force 1d.");
  ...
  function()
    return AiLoop(ai_loop_funcs, ai_loop_pos)
  end,
}
...
RegisterAi("spacious", "spacious", AiSpacious, InitAiScripts_spacious)
