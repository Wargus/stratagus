...
def replace_global_vertex(source):
    ...
    replace_table = [
        ...
        ('_modelViewProj1', 'gl_ModelViewProjectionMatrix'),
        ('_IN1._mvp_matrix[0]', 'gl_ModelViewProjectionMatrix[0]'),
        ('_IN1._mvp_matrix[1]', 'gl_ModelViewProjectionMatrix[1]'),
        ('_IN1._mvp_matrix[2]', 'gl_ModelViewProjectionMatrix[2]'),
        ('_IN1._mvp_matrix[3]', 'gl_ModelViewProjectionMatrix[3]'),
...
def translate_varying(cg):
    translations = {
        'IN.tex_coord': 'gl_MultiTexCoord0',
        'IN.vertex_coord': 'gl_Vertex',
