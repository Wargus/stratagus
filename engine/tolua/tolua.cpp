...
** Generated automatically by tolua++-1.0.92 on 03/27/07 20:53:37.
*/
...
/* function: UpdateUnitsConsumingResources */
#ifndef TOLUA_DISABLE_tolua_stratagus_UpdateUnitsConsumingResources00
static int tolua_stratagus_UpdateUnitsConsumingResources00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  ...
  {
   UpdateUnitsConsumingResources(slot,costs);
  }
  {
   int i;
   for(i=0; i<MaxCosts;i++)
...
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'UpdateUnitsConsumingResources'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE

/* function: RemoveFromUnitsConsumingResources */
#ifndef TOLUA_DISABLE_tolua_stratagus_RemoveFromUnitsConsumingResources00
static int tolua_stratagus_RemoveFromUnitsConsumingResources00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#endif
 {
  int slot = ((int)  tolua_tonumber(tolua_S,1,0));
  {
   RemoveFromUnitsConsumingResources(slot);
  }
 }
 return 0;
#ifndef TOLUA_RELEASE
 tolua_lerror:
 tolua_error(tolua_S,"#ferror in function 'RemoveFromUnitsConsumingResources'.",&tolua_err);
 return 0;
#endif
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_stratagus_open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_function(tolua_S,"UpdateUnitsConsumingResources",tolua_stratagus_UpdateUnitsConsumingResources00);
  tolua_function(tolua_S,"RemoveFromUnitsConsumingResources",tolua_stratagus_RemoveFromUnitsConsumingResources00);
